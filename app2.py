...
def main():
    ...
    col_name = st.selectbox('1개의 공을 선택하세요!', iris['species'].unique())
    st.write(col_name)
    ...
    ax[0].scatter(result['sepal_length'], result['sepal_width'])
    ax[0].set_title('matplotlib')
    
    sns.scatterplot(result, x = 'sepal_length', y = 'sepal_width', ax = ax[1])
